...
void loop(void)
{
    ...
    if (error == 0)
    {
        ...
        vol = temp *1000;
        M5.Lcd.drawCentreString("Raw data ",10, 10, 2);
        M5.Lcd.drawCentreString(data, 50, 35, 4);
        sprintf(data, "%d", vol);
        M5.Lcd.setTextColor(GREEN);
        M5.Lcd.drawCentreString("Convert to ", 10, 90, 2);
        M5.Lcd.drawCentreString(data, 50, 115, 4);
        
        M5.Lcd.drawCentreString("mV", 110, 118, 2);
