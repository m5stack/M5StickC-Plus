...
void setup() {
  ...
  M5.Lcd.setCursor(30, 40); M5.Lcd.print(" x ");
  M5.Lcd.setCursor(30, 80); M5.Lcd.print(" y ");
  M5.Lcd.setCursor(30, 120); M5.Lcd.print(" z ");
...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    M5.Lcd.setCursor(60,  40); M5.Lcd.print((int)(1000*accel.getX()));
     M5.Lcd.fillRect(60, 80, 80, 20, BLACK);
    M5.Lcd.setCursor(60, 80); M5.Lcd.print((int)(1000*accel.getY()));
     M5.Lcd.fillRect(60, 120, 80, 20, BLACK);
    M5.Lcd.setCursor(60, 120); M5.Lcd.print((int)(1000*accel.getZ()));
