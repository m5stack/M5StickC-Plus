...
void loop() {
  ...
  M5.Lcd.setCursor(40,25); M5.Lcd.print("Blue Status: ");
  M5.Lcd.setCursor(40,40); M5.Lcd.print("Blue Value: ");
  M5.Lcd.setCursor(40,55); M5.Lcd.print(" Red Status: ");
  M5.Lcd.setCursor(40,70); M5.Lcd.print(" Red Value: ");

  if(cur_value_blue != last_value_blue){
    M5.Lcd.fillRect(135,25,100,15,BLACK);
    M5.Lcd.fillRect(135,40,100,15,BLACK);
    if(cur_value_blue==0){
      M5.Lcd.setCursor(135,25); M5.Lcd.print("pressed");
      M5.Lcd.setCursor(135,40); M5.Lcd.print("0");
      Serial.println("Button Status: blue pressed");
      Serial.println(" value: 0");
    }
    else{
      M5.Lcd.setCursor(135,25); M5.Lcd.print("released");
      M5.Lcd.setCursor(135,40); M5.Lcd.print("1");
    ...
    if(cur_value_red != last_value_red){
      ...
      if(cur_value_red==0){
        M5.Lcd.setCursor(135,55); M5.Lcd.print("pressed");
        M5.Lcd.setCursor(135,70); M5.Lcd.print("0");
        Serial.println("Button Status: red pressed");
        Serial.println(" value: 0");
      }
      else{
        M5.Lcd.setCursor(135,55); M5.Lcd.print("released");
        M5.Lcd.setCursor(135,70); M5.Lcd.print("1");
